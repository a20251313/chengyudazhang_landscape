...
- (void) PurchasedTransaction: (SKPaymentTransaction *)transaction{
    ...
    DLOG(@"+++PurchasedTransaction in mystoreobserver.m");
}
...
//    NSLog(@"Transaction transactionIdentifier : %@", transaction.transactionIdentifier);
    ...
    DLOG(@"+++completeTransaction in mystoreobserver.m");
}
...
- (void) failedTransaction: (SKPaymentTransaction *)transaction
{
	...
	[[SKPaymentQueue defaultQueue] finishTransaction: transaction];
    DLOG(@"+++failedTransaction in mystoreobserver.m");
}

- (void)restoreTransaction:(SKPaymentTransaction *)transaction
{
    [[SKPaymentQueue defaultQueue] finishTransaction: transaction];
     DLOG(@"+++restoreTransaction in mystoreobserver.m");
}
